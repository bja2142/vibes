...
TOOL_DRCOV         = _env("PWN_MCP_DRCOV",          "/opt/dynamorio/tools/lib64/release/libdrcov.so")
TOOL_CAPA          = _env("PWN_MCP_CAPA",           "capa")
CAPA_RULES_DIR     = Path(_env("PWN_MCP_CAPA_RULES_DIR", "/opt/capa-rules"))
TOOL_FLOSS         = _env("PWN_MCP_FLOSS",          "floss")
TOOL_YARA          = _env("PWN_MCP_YARA",           "yara")
TOOL_R2            = _env("PWN_MCP_R2",             "r2")
TOOL_RABIN2        = _env("PWN_MCP_RABIN2",         "rabin2")
TOOL_RASM2         = _env("PWN_MCP_RASM2",          "rasm2")
TOOL_NASM          = _env("PWN_MCP_NASM",           "nasm")
